...
$string['pluginname'] = 'NexoSupport Core';
$string['sitename'] = 'NexoSupport';

// Errors
$string['error'] = 'Error';
$string['invalidlogin'] = 'Invalid username or password';
$string['nopermissions'] = 'You do not have permission to perform this action';
$string['invalidsesskey'] = 'Invalid session key. Please try again.';
$string['notinstalled'] = 'The system is not installed';
...
// Messages
$string['changessaved'] = 'Changes have been saved';
