...
$string['upgrader_log_plugins'] = 'Procesando plugins';
$string['upgrader_plugins_uptodate'] = 'Todos los plugins están actualizados';
$string['upgrader_plugin_installing'] = 'Instalando plugin: {$a}';
$string['upgrader_plugin_upgrading'] = 'Actualizando plugin: {$a}';
$string['upgrader_plugin_failed'] = 'Error al procesar plugin: {$a}';
$string['upgrader_plugins_error'] = 'Error procesando plugins';
